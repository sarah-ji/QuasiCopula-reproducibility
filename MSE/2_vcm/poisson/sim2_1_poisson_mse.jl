...
function runtest()
    ...
    # make sure poisson_vc2_1 is a directory
    isdir("poisson_vc2_1") || mkdir("poisson_vc2_1")

    writedlm("poisson_vc2_1/mse_beta_" * ftail, βMseResults, ',')
    writedlm("poisson_vc2_1/mse_theta_" * ftail, θMseResults, ',')
    writedlm("poisson_vc2_1/fittimes_" * ftail, fittimes, ',')

    writedlm("poisson_vc2_1/beta_theta_coverage_" * ftail, βθcoverage, ',')

#     # glmm
    writedlm("poisson_vc2_1/mse_beta_GLMM_" * ftail, βMseResults_GLMM, ',')
    writedlm("poisson_vc2_1/mse_theta_GLMM_" * ftail, θMseResults_GLMM, ',')
    writedlm("poisson_vc2_1/fittimes_GLMM_" * ftail, fittimes_GLMM, ',')
end
runtest()
