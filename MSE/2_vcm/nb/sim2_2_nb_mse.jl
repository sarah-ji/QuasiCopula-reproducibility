...
function runtest()
    ...
    # make sure nb_vc2_2 is a directory
    isdir("nb_vc2_2") || mkdir("nb_vc2_2")

    writedlm("nb_vc2_2/mse_beta_" * ftail, βMseResults, ',')
    writedlm("nb_vc2_2/mse_theta_" * ftail, θMseResults, ',')
    writedlm("nb_vc2_2/mse_r_" * ftail, rMseResults, ',')
    writedlm("nb_vc2_2/fittimes_" * ftail, fittimes, ',')

    writedlm("nb_vc2_2/beta_r_theta_coverage_" * ftail, βrθcoverage, ',')

    # glmm
    writedlm("nb_vc2_2/mse_beta_GLMM_" * ftail, βMseResults_GLMM, ',')
    writedlm("nb_vc2_2/mse_theta_GLMM_" * ftail, θMseResults_GLMM, ',')
    writedlm("nb_vc2_2/mse_r_GLMM" * ftail, rMseResults_GLMM, ',')
    writedlm("nb_vc2_2/fittimes_GLMM_" * ftail, fittimes_GLMM, ',')
end
runtest()
